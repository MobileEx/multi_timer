...
class PlayerAddingFromTeamScreen extends StatefulWidget {
  @override
  _PlayerAddingFromTeamScreenState createState() =>
      _PlayerAddingFromTeamScreenState();
}

class _PlayerAddingFromTeamScreenState
    extends State<PlayerAddingFromTeamScreen> {
  ...
  void _save() {
    if (player.playerNO == null) {
      ...
      if (playerNoExistCheck(context, playerNo)) {
      ...
      if (player.playerName == null) {
        ...
        Provider.of<TeamDataProvider>(context, listen: false).addPlayer(player);
  ...
  bool playerNoExistCheck(context, playerNO) {
    bool duplicate = false;
    Provider.of<TeamDataProvider>(context, listen: false)
        .player
        .forEach((existingPlayer) {
      if (existingPlayer.playerNO == playerNO) {
