...
Widget addSegmentDialog(BuildContext context, {int segments, ValueChanged<String> onChange}) {
  ...
  return CupertinoAlertDialog(
    title: new Text("Segments in game"),
    content: Column(
      children: [
        new Text("How many Segment in your game?"),
        SizedBox(
          height: 16,
        ),
        SizedBox(
